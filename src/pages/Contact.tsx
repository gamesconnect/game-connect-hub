          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-8">
                We're always excited to connect with new members and partners. Reach out through any of these channels!
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-2xl">
                  ...
                  <div>
                    ...
                    <a href="tel:+233505891665" className="text-muted-foreground hover:text-primary transition-colors">
                      +233 50 589 1665
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-2xl">
                  ...
                  <div>
                    ...
                    <a href="mailto:events@gamesandconnect.com" className="text-muted-foreground hover:text-primary transition-colors">
                ...
                <div className="flex items-start gap-4 p-4 bg-card rounded-2xl">
                  ...
                  <div>
                    <h3 className="font-bold text-foreground mb-1">WhatsApp Community</h3>
                    <Button
                      variant="link"
